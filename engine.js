...
function startGame(type, mode) {
  ...
  document.onkeydown = function keyMovement(e) {
	...
	if (e.keyCode) var keyId = e.keyCode, up = 38, down = 40, w = 87, s = 83, p = 80;
  ...
  function playerControl(last, turbo) {
      console.log("playerControl", last, turbo);
